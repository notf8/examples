...
========================================================================================================================
 ...
 - Создаем суперюсера - python manage.py createsuperuser (логин: admin, почта пустая, пароль: 1234)
...
в интернет магазине отдельно существуют приложения "корзина", "личный кабинет", "каталог" и т.д.Все
