...
# i = 2 # Цикл начнем с 2
#
# while i <= n / 2: # Перебираем число, пока i меньше половины списка, после прохода половины списка перебирать смысла нет
#     if a[i] != 0: # Если текущая ячейка не занята 0, значит мы встретили простое число
#         j = i + i # Будем вычекркивать из списка кратные i числа. Первое кратное ему число больше i  в два раза (6 первое кратное 3)
#         while j <= n:
