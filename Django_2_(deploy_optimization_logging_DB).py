...
- Что бы сгенерировать случайно secret key, в терминале вводим: openssl rand -hex 32 # Так мы получим рандомную строку. Ее копируем и вставляем
 ...
 - После можно запускать контейнер. В терминале: docker compose up -d app (если не установлен, то можно установить командой: apt  install docker.io
...
Адрес моей виртуалки: 94.241.141.104, my_django_app.com