...
в будущей БД будут:
 ...
 - Связи
 Правило! Если какое то свойство БД сложнее обычного числа или строки (напримар статус сделки, который имеет и на звание
и цвет - то его стоит вынести в отдельную таблицу и установить с ней связь)
========================================================================================================================
